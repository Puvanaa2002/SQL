...
-- select first_name,last_name , grade, marks
-- from student
-- order by grade +0,marks desc
-- limit 30;
-- select*from student;
-- select distinct grade from student

-- create database puvanaa;
-- use puvanaa;
-- create table puvanaa (name varchar(50),age int,gender varchar(50),city char(50));
-- select * from puvanaa;
-- insert into puvanaa values("puvanaa",23,"female","thoothukudi");
-- select * from puvanaa;
-- insert into puvanaa values ("kaviya",24,"female","salem"),("mathesh",23,"male","trichy"),("arafath",25,"male","covai"),("ram",26,"male","chennai");
-- select * from puvanaa; 
-- update puvanaa set name="rathi" where city="salem"
-- select * from puvanaa; 
-- delete from puvanaa where city = "chennai";
-- select * from puvanaa; 
-- alter table puvanaa change city area varchar(50); 
-- select * from puvanaa; 
-- alter table puvanaa add column id int auto_increment primary key first;
-- select * from puvanaa;
-- alter table puvanaa add column pincode int; 
-- select * from puvanaa;
-- update puvanaa set pincode=1 where id=1
-- update puvanaa set pincode=2 where id=2 
-- update puvanaa set pincode=3 where id=3
-- update puvanaa set pincode=4 where id=4
-- select * from puvanaa;
...
-- );
-- INSERT INTO employees (employee_id, first_name, last_name, job_title, salary, department_id, hire_date)
-- VALUES
...
-- select*from employees
-- select first_name,hire_date,year(hire_date)as hire_year from employees;
-- select first_name,hire_date,month(hire_date)as hire_year from employees;
